...
figma.ui.onmessage = (msg) => {
    ...
    if (msg.type === "import") {
        ...
        figma.variables.getLocalVariableCollectionsAsync().then((localCollections) => {
            ...
            const importedModeIds = Object.keys((_a = importedVariablesObject[0]) === null || _a === void 0 ? void 0 : _a.valuesByMode);
...
function ExportToCSV(data, collection) {
    // Create headers
...
function UpdateVariables(importedVariablesObject, collection, collectionId, modesIdsOnFigma) {
